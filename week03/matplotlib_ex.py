...
# plt.subplot() 함수를 사용하여 하나의 그림인 figure에 개별 서브 플롯을 하나씩 추가
# 첫 번째 서브플롯 설정 (선그래프)
plt.subplot(2,1,1)
# 선 그래프 그리기
...
# 제목 설정
plt.suptitle('Survuval Analysis by Number of Parents/Chileren (Parch) on the Titanic')
plt.tight_layout()
...
# 두 번째 서브플롯 설정(막대 그래프)
axes[1].bar(x,y2,'-o',color='indigo',alpha=0.7,width=0.5,label='Survived')
